...
const Waves = ({
  ...
  waveSpeedY = 0.003, // Reduced for better performance
  waveAmpX = 24, // Reduced amplitude
  waveAmpY = 12, // Reduced amplitude
  xGap = 12, // Increased gap to reduce line count
  yGap = 36, // Increased gap to reduce line count
